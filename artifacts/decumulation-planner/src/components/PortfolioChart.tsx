...
const ASSET_CLASSES = [
  ...
  { key: 'property_investment', label: 'Property', color: '#F59E0B' },
...
export default function PortfolioChart({ perYear, planYears, firstShortfallYear }: Props) {
  if (perYear.length === 0) return null;

  const chartData = perYear.map(yr => {
