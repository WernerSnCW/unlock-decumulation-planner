...
export const PORTFOLIO_PRESETS: PortfolioPreset[] = [
  ...
  {
    name: 'Tony',
    description: '£15M+ HNW portfolio — property, SIPP, VCTs, stocks, collectables, PET transfers active',
    suggested_inputs: {
      current_age: 78,
    ...
    assets: [
      ...
      makeAsset({
        ...
        asset_class: 'property_investment',
        wrapper_type: 'unwrapped',
        label: 'Investment Property 3',
        current_value: 1500000,
        acquisition_cost: 700000,
        acquisition_date: '2014-09-01',
        assumed_growth_rate: 0.03,
        income_generated: 6250,
        disposal_type: 'transfer',
        transfer_year: 3,
      ...
      makeAsset({
        asset_id: 'tony-property-005',
        asset_class: 'property_investment',
        wrapper_type: 'unwrapped',
        label: 'Investment Property 4',
        current_value: 1500000,
      ...
      makeAsset({
        asset_id: 'tony-gia-001',
        asset_class: 'isa',
        wrapper_type: 'unwrapped',
        label: 'Stocks & Shares — GIA',
        current_value: 2000000,
        acquisition_cost: 800000,
        assumed_growth_rate: 0.06,
        income_generated: 180000,
      }),
      makeAsset({
